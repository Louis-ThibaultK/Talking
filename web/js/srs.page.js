 ...
 */
function srs_get_player_modal() {
  return 740;
}
function srs_get_player_width() {
  return srs_get_player_modal() - 30;
}
function srs_get_player_height() {
  return (srs_get_player_width() * 9) / 19;
}
...
function build_default_rtc_url(query) {
  ...
  console.log(
    "?eip=x.x.x.x to overwrite candidate. 瑕嗙洊鏈嶅姟鍣╟andidate(澶栫綉IP)閰嶇疆"
  );
