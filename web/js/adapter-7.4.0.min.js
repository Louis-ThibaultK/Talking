            ...
            (r.shimAddTrackRemoveTrack = function (e) {
              ...
              e.RTCPeerConnection.prototype.setLocalDescription = function () {
                return arguments.length && arguments[0].type
                  ? ((arguments[0] = d(this, arguments[0])),
                  ...
                  l.forEach(function (o, c) {
                    ...
                    if (
                      ...
                      var j = n.parseRtcpParameters(o),
                        L =
                          n.matchPrefix(o, "a=end-of-candidates", m).length > 0,
                        G = n
                      ...
                      if (
                        ...
                        ((P =
                          p.transceivers[c] || p._createTransceiver(l)).mid =
                          T),
                          P.iceGatherer ||
                        ...
                        if ("sendrecv" === C || "sendonly" === C) {
                          ...
                          P.rtpReceiver &&
                            P.rtpReceiver.track &&
                            (P.associatedRemoteMediaStreams.forEach(function (
                              t
                            ) {
